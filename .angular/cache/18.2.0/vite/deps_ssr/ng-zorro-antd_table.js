...
var _NzPaginationComponent = class _NzPaginationComponent {
  ...
  constructor(i18n, cdr, breakpointService, nzConfigService, directionality) {
    ...
    this.dir = "ltr";
    this.destroy$ = new import_rxjs4.Subject();
    this.total$ = new import_rxjs4.ReplaySubject(1);
  }
  ngOnInit() {
    ...
    this.total$.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((total) => {
      this.onTotalChange(total);
    });
    this.breakpointService.subscribe(gridResponsiveMap).pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe((bp) => {
...
var _NzFilterTriggerComponent = class _NzFilterTriggerComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs5.fromEvent)(this.nzDropdown.nativeElement, "click").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((event) => {
        event.stopPropagation();
      });
    });
  }
...
var _NzTableFilterComponent = class _NzTableFilterComponent {
  ...
  ngOnInit() {
    this.i18n.localeChange.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
...
var _NzTableStyleService = class _NzTableStyleService {
  constructor() {
    this.theadTemplate$ = new import_rxjs5.ReplaySubject(1);
    this.tfootTemplate$ = new import_rxjs5.ReplaySubject(1);
    this.tfootFixed$ = new import_rxjs5.ReplaySubject(1);
    this.hasFixLeft$ = new import_rxjs5.ReplaySubject(1);
    this.hasFixRight$ = new import_rxjs5.ReplaySubject(1);
    this.hostWidth$ = new import_rxjs5.ReplaySubject(1);
    this.columnCount$ = new import_rxjs5.ReplaySubject(1);
    this.showEmpty$ = new import_rxjs5.ReplaySubject(1);
    this.noResult$ = new import_rxjs5.ReplaySubject(1);
    this.listOfThWidthConfigPx$ = new import_rxjs5.BehaviorSubject([]);
    this.tableWidthConfigPx$ = new import_rxjs5.BehaviorSubject([]);
    this.manualWidthConfigPx$ = (0, import_rxjs5.combineLatest)([this.tableWidthConfigPx$, this.listOfThWidthConfigPx$]).pipe((0, import_operators5.map)(([widthConfig, listOfWidth]) => widthConfig.length ? widthConfig : listOfWidth));
    this.listOfAutoWidthPx$ = new import_rxjs5.ReplaySubject(1);
    this.listOfListOfThWidthPx$ = (0, import_rxjs5.merge)(
      /** init with manual width **/
      this.manualWidthConfigPx$,
      (0, import_rxjs5.combineLatest)([this.listOfAutoWidthPx$, this.manualWidthConfigPx$]).pipe((0, import_operators5.map)(([autoWidth, manualWidth]) => {
    ...
    this.listOfMeasureColumn$ = new import_rxjs5.ReplaySubject(1);
    this.listOfListOfThWidth$ = this.listOfAutoWidthPx$.pipe((0, import_operators5.map)((list) => list.map((width) => parseInt(width, 10))));
    this.enableAutoMeasure$ = new import_rxjs5.ReplaySubject(1);
  }
...
var _NzTableDataService = class _NzTableDataService {
  ...
  constructor() {
    this.destroy$ = new import_rxjs5.Subject();
    this.pageIndex$ = new import_rxjs5.BehaviorSubject(1);
    this.frontPagination$ = new import_rxjs5.BehaviorSubject(true);
    this.pageSize$ = new import_rxjs5.BehaviorSubject(10);
    this.listOfData$ = new import_rxjs5.BehaviorSubject([]);
    this.listOfCustomColumn$ = new import_rxjs5.BehaviorSubject([]);
    this.pageIndexDistinct$ = this.pageIndex$.pipe((0, import_operators5.distinctUntilChanged)());
    this.pageSizeDistinct$ = this.pageSize$.pipe((0, import_operators5.distinctUntilChanged)());
    this.listOfCalcOperator$ = new import_rxjs5.BehaviorSubject([]);
    this.queryParams$ = (0, import_rxjs5.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfCalcOperator$]).pipe((0, import_operators5.debounceTime)(0), (0, import_operators5.skip)(1), (0, import_operators5.map)(([pageIndex, pageSize, listOfCalc]) => ({
      pageIndex,
      pageSize,
    ...
    this.listOfDataAfterCalc$ = (0, import_rxjs5.combineLatest)([this.listOfData$, this.listOfCalcOperator$]).pipe((0, import_operators5.map)(([listOfData, listOfCalcOperator]) => {
    ...
    this.listOfFrontEndCurrentPageData$ = (0, import_rxjs5.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfDataAfterCalc$]).pipe((0, import_operators5.takeUntil)(this.destroy$), (0, import_operators5.filter)((value) => {
      const [pageIndex, pageSize, listOfData] = value;
      const maxPageIndex = Math.ceil(listOfData.length / pageSize) || 1;
      return pageIndex <= maxPageIndex;
    }), (0, import_operators5.map)(([pageIndex, pageSize, listOfData]) => listOfData.slice((pageIndex - 1) * pageSize, pageIndex * pageSize)));
    this.listOfCurrentPageData$ = this.frontPagination$.pipe((0, import_operators5.switchMap)((pagination) => pagination ? this.listOfFrontEndCurrentPageData$ : this.listOfDataAfterCalc$));
    this.total$ = this.frontPagination$.pipe((0, import_operators5.switchMap)((pagination) => pagination ? this.listOfDataAfterCalc$ : this.listOfData$), (0, import_operators5.map)((list) => list.length), (0, import_operators5.distinctUntilChanged)());
  }
  ngOnDestroy() {
    this.destroy$.next(true);
    this.destroy$.complete();
...
var _NzCustomColumnDirective = class _NzCustomColumnDirective {
  ...
  ngOnInit() {
    this.nzTableDataService.listOfCustomColumn$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((item) => {
      if (item.length) {
        item.forEach((v, i) => {
...
var _NzThAddOnComponent = class _NzThAddOnComponent {
  ...
  constructor(host, cdr, ngZone, destroy$) {
    ...
    this.ngZone = ngZone;
    this.destroy$ = destroy$;
    this.manualClickOrder$ = new import_rxjs5.Subject();
    this.calcOperatorChange$ = new import_rxjs5.Subject();
    this.nzFilterValue = null;
    this.sortOrder = null;
    this.sortDirections = ["ascend", "descend", null];
    this.sortOrderChange$ = new import_rxjs5.Subject();
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => (0, import_rxjs5.fromEvent)(this.host.nativeElement, "click").pipe((0, import_operators5.filter)(() => this.nzShowSort), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
    ...
    this.sortOrderChange$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((order) => {
...
var _NzTableFixedRowComponent = class _NzTableFixedRowComponent {
  constructor(nzTableStyleService, renderer) {
    ...
    this.renderer = renderer;
    this.hostWidth$ = new import_rxjs5.BehaviorSubject(null);
    this.enableAutoMeasure$ = new import_rxjs5.BehaviorSubject(false);
    this.destroy$ = new import_rxjs5.Subject();
  }
  ngOnInit() {
    if (this.nzTableStyleService) {
      ...
      enableAutoMeasure$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.enableAutoMeasure$);
      hostWidth$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.hostWidth$);
    }
  }
  ngAfterViewInit() {
    this.nzTableStyleService.columnCount$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((count) => {
...
var _NzTrMeasureComponent = class _NzTrMeasureComponent {
  ...
  ngAfterViewInit() {
    this.listOfTdElement.changes.pipe((0, import_operators5.startWith)(this.listOfTdElement)).pipe((0, import_operators5.switchMap)((list) => (0, import_rxjs5.combineLatest)(list.toArray().map((item) => this.nzResizeObserver.observe(item).pipe((0, import_operators5.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      return Math.floor(width);
    }))))), (0, import_operators5.debounceTime)(16), (0, import_operators5.takeUntil)(this.destroy$)).subscribe((data) => {
...
var _NzTbodyComponent = class _NzTbodyComponent {
  constructor() {
    ...
    this.showEmpty$ = new import_rxjs5.BehaviorSubject(false);
    this.noResult$ = new import_rxjs5.BehaviorSubject(void 0);
    this.listOfMeasureColumn$ = new import_rxjs5.BehaviorSubject([]);
    this.destroy$ = new import_rxjs5.Subject();
    ...
    if (this.nzTableStyleService) {
      ...
      noResult$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.noResult$);
      listOfMeasureColumn$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.listOfMeasureColumn$);
      showEmpty$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.showEmpty$);
    }
  }
...
var _NzTableInnerScrollComponent = class _NzTableInnerScrollComponent {
  ...
  constructor(renderer, ngZone, platform, resizeService) {
    ...
    this.data$ = new import_rxjs5.Subject();
    this.scroll$ = new import_rxjs5.Subject();
    this.destroy$ = new import_rxjs5.Subject();
  }
  ngOnChanges(changes) {
    const {
  ...
  ngAfterViewInit() {
    if (this.platform.isBrowser) {
      this.ngZone.runOutsideAngular(() => {
        const scrollEvent$ = this.scroll$.pipe((0, import_operators5.startWith)(null), (0, import_operators5.delay)(0), (0, import_operators5.switchMap)(() => (0, import_rxjs5.fromEvent)(this.tableBodyElement.nativeElement, "scroll").pipe((0, import_operators5.startWith)(true))), (0, import_operators5.takeUntil)(this.destroy$));
        const resize$ = this.resizeService.subscribe().pipe((0, import_operators5.takeUntil)(this.destroy$));
        const data$ = this.data$.pipe((0, import_operators5.takeUntil)(this.destroy$));
        const setClassName$ = (0, import_rxjs5.merge)(scrollEvent$, resize$, data$, this.scroll$).pipe((0, import_operators5.startWith)(true), (0, import_operators5.delay)(0), (0, import_operators5.takeUntil)(this.destroy$));
        setClassName$.subscribe(() => this.setScrollPositionClassName());
        scrollEvent$.pipe((0, import_operators5.filter)(() => !!this.scrollY)).subscribe(() => {
...
var _NzTableComponent = class _NzTableComponent {
  ...
  constructor(elementRef, nzResizeObserver, nzConfigService, cdr, nzTableStyleService, nzTableDataService, directionality) {
    ...
    this.showPagination = true;
    this.destroy$ = new import_rxjs5.Subject();
    this.templateMode$ = new import_rxjs5.BehaviorSubject(false);
    this.dir = "ltr";
    this.verticalScrollBarWidth = 0;
    this.nzConfigService.getConfigChangeEventForComponent(NZ_CONFIG_MODULE_NAME3).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
      this.cdr.markForCheck();
    });
  }
  ngOnInit() {
    ...
    queryParams$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.nzQueryParams);
    pageIndexDistinct$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((pageIndex) => {
      if (pageIndex !== this.nzPageIndex) {
        this.nzPageIndex = pageIndex;
        this.nzPageIndexChange.next(pageIndex);
      }
    });
    pageSizeDistinct$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((pageSize) => {
      if (pageSize !== this.nzPageSize) {
        this.nzPageSize = pageSize;
        this.nzPageSizeChange.next(pageSize);
      }
    });
    total$.pipe((0, import_operators5.takeUntil)(this.destroy$), (0, import_operators5.filter)(() => this.nzFrontPagination)).subscribe((total) => {
      if (total !== this.nzTotal) {
        this.nzTotal = total;
        this.cdr.markForCheck();
      }
    });
    listOfCurrentPageData$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((data) => {
      this.data = data;
      this.nzCurrentPageDataChange.next(data);
      this.cdr.markForCheck();
    });
    listOfCustomColumn$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((data) => {
      this.nzCustomColumn = data;
      this.nzCustomColumnChange.next(data);
      this.cdr.markForCheck();
    });
    theadTemplate$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((theadTemplate) => {
      this.theadTemplate = theadTemplate;
      this.cdr.markForCheck();
    });
    (0, import_rxjs5.combineLatest)([tfootTemplate$, tfootFixed$]).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(([tfootTemplate, tfootFixed]) => {
      this.tfootTemplate = tfootTemplate;
      this.tfootFixed = tfootFixed;
      this.cdr.markForCheck();
    });
    hasFixLeft$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((hasFixLeft) => {
      this.hasFixLeft = hasFixLeft;
      this.cdr.markForCheck();
    });
    hasFixRight$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((hasFixRight) => {
      this.hasFixRight = hasFixRight;
      this.cdr.markForCheck();
    });
    (0, import_rxjs5.combineLatest)([total$, this.templateMode$]).pipe((0, import_operators5.map)(([total, templateMode]) => total === 0 && !templateMode), (0, import_operators5.takeUntil)(this.destroy$)).subscribe((empty) => {
      this.nzTableStyleService.setShowEmpty(empty);
    });
    this.verticalScrollBarWidth = measureScrollbar("vertical");
    this.nzTableStyleService.listOfListOfThWidthPx$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
      this.listOfAutoColWidth = listOfWidth;
      this.cdr.markForCheck();
    });
    this.nzTableStyleService.manualWidthConfigPx$.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
  ...
  ngAfterViewInit() {
    this.nzResizeObserver.observe(this.elementRef).pipe((0, import_operators5.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      const scrollBarWidth = this.scrollY ? this.verticalScrollBarWidth : 0;
      return Math.floor(width - scrollBarWidth);
    }), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.nzTableStyleService.hostWidth$);
...
var _NzTrDirective = class _NzTrDirective {
  constructor() {
    this.destroy$ = new import_rxjs5.Subject();
    this.listOfFixedColumns$ = new import_rxjs5.ReplaySubject(1);
    this.listOfColumns$ = new import_rxjs5.ReplaySubject(1);
    this.listOfFixedColumnsChanges$ = this.listOfFixedColumns$.pipe((0, import_operators5.switchMap)((list) => (0, import_rxjs5.merge)(...[this.listOfFixedColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators5.mergeMap)(() => this.listOfFixedColumns$))), (0, import_operators5.takeUntil)(this.destroy$));
    this.listOfFixedLeftColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators5.map)((list) => list.filter((item) => item.nzLeft !== false)));
    this.listOfFixedRightColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators5.map)((list) => list.filter((item) => item.nzRight !== false)));
    this.listOfColumnsChanges$ = this.listOfColumns$.pipe((0, import_operators5.switchMap)((list) => (0, import_rxjs5.merge)(...[this.listOfColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators5.mergeMap)(() => this.listOfColumns$))), (0, import_operators5.takeUntil)(this.destroy$));
    this.nzTableStyleService = inject(NzTableStyleService, {
      optional: true
    });
    this.isInsideTable = !!this.nzTableStyleService;
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      this.listOfCellFixedDirective.changes.pipe((0, import_operators5.startWith)(this.listOfCellFixedDirective), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.listOfFixedColumns$);
      this.listOfNzThDirective.changes.pipe((0, import_operators5.startWith)(this.listOfNzThDirective), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(this.listOfColumns$);
      ...
      (0, import_rxjs5.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedLeftColumnChanges$]).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfLeftCell]) => {
      ...
      (0, import_rxjs5.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedRightColumnChanges$]).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfRightCell]) => {
...
var _NzTheadComponent = class _NzTheadComponent {
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      const firstTableRow$ = this.listOfNzTrDirective.changes.pipe((0, import_operators5.startWith)(this.listOfNzTrDirective), (0, import_operators5.map)((item) => item && item.first));
      const listOfColumnsChanges$ = firstTableRow$.pipe((0, import_operators5.switchMap)((firstTableRow) => firstTableRow ? firstTableRow.listOfColumnsChanges$ : import_rxjs5.EMPTY), (0, import_operators5.takeUntil)(this.destroy$));
      listOfColumnsChanges$.subscribe((data) => this.nzTableStyleService.setListOfTh(data));
      this.nzTableStyleService.enableAutoMeasure$.pipe((0, import_operators5.switchMap)((enable) => enable ? listOfColumnsChanges$ : (0, import_rxjs5.of)([]))).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((data) => this.nzTableStyleService.setListOfMeasureColumn(data));
      const listOfFixedLeftColumnChanges$ = firstTableRow$.pipe((0, import_operators5.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedLeftColumnChanges$ : import_rxjs5.EMPTY), (0, import_operators5.takeUntil)(this.destroy$));
      const listOfFixedRightColumnChanges$ = firstTableRow$.pipe((0, import_operators5.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedRightColumnChanges$ : import_rxjs5.EMPTY), (0, import_operators5.takeUntil)(this.destroy$));
    ...
    if (this.nzTableDataService) {
      const listOfColumn$ = this.listOfNzThAddOnComponent.changes.pipe((0, import_operators5.startWith)(this.listOfNzThAddOnComponent));
      const manualSort$ = listOfColumn$.pipe((0, import_operators5.switchMap)(() => (0, import_rxjs5.merge)(...this.listOfNzThAddOnComponent.map((th) => th.manualClickOrder$))), (0, import_operators5.takeUntil)(this.destroy$));
      ...
      const listOfCalcOperator$ = listOfColumn$.pipe(
        (0, import_operators5.switchMap)((list) => (0, import_rxjs5.merge)(...[listOfColumn$, ...list.map((c) => c.calcOperatorChange$)]).pipe((0, import_operators5.mergeMap)(() => listOfColumn$))),
        (0, import_operators5.map)((list) => list.filter((item) => !!item.nzSortFn || !!item.nzFilterFn).map((item) => {
          const {
            nzSortFn,
            sortOrder,
            nzFilterFn,
